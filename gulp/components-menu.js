module.exports = function (processor) {
    var ComponentsMenu = [
        {
            ...
            children : [
                ...
                {
                    name: '<i class="fa fa-sliders"></i> Sliders',
                    link: 'component-slider.html'
                },
                {
        ...
        },
        {
            ...
            children : [
                ...
                {
                    name: '<i class="fa fa-arrow-circle-right"></i> Ionicons',
                    link: 'component-icons-ionicons.html'
                },
            ]
        },
        {
            ...
            children : [
                ...
                {
                    name: '<i class="zmdi zmdi-tag"></i> Badges &amp; Badges Pills',
                    link: 'component-badges.html'
                },
                {
                ...
                {
                    name: '<i class="zmdi zmdi-label-alt-outline"></i> Breadcrumb',
                    link: 'component-breadcrumb.html'
                },
                {
        ...
        },
        {
            ...
            children : [
                ...
                {
                    name: '<i class="zmdi zmdi-collection-image-o"></i> Lightbox',
                    link: 'component-lightbox.html',
                },
            ]
        },
        {
    ...
    processor.registerBlockType('componentsMenu', function (content, block, blockLine, blockContent) {
        ...
        menu += '<div class="col-lg-3 ms-paper-menu-left-container">' +
    ...
    function generateMenu(name, children, active_link, num) {
        ...
        var r = '<li class="card" role="tab" id="e' + num +'">';
        r += '<a role="button" data-toggle="collapse" href="#c' + num + '" aria-expanded="true" aria-controls="c' + num + '" class="';
        r += active ? '' : 'collapsed ';
        r += 'withripple">';
        r += name + '</a>';
        r += '<ul id="c' + num + '" class="panel-collapse collapse';
        r += active ? ' show' : '';
        r += '" role="tabpanel" aria-labelledby="e' + num + '" data-parent="#components-nav">';
        r += submbenu;
        r+= '</ul></li>';
        return r;
    }
